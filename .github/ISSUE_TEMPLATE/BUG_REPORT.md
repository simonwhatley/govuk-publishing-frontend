...
- [ ] Put an X between the brackets on this line if you have done all of the following:
    ...
    - Checked that your issue doesn't exist: https://github.com/whatterz/govuk-publishing-frontend/issues
...
You can get this information from the [CHANGELOG](https://github.com/whatterz/govuk-publishing-frontend/blob/master/CHANGELOG.md). Also, please include details of the browser and OS version you're running.
