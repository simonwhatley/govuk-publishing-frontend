...
if [[ -n $(git status --porcelain) ]]; then
  ...
  git commit -m "Release GOV.UK Publishing Frontend to '$BRANCH_NAME' for testing"
...
echo
echo "✅ To install the pushed branch release run 'npm install --save @simonwhatley/govuk-publishing-frontend#$BRANCH_COMMIT_SHA'"
