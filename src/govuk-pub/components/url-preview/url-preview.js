...
(function (Modules) {
  ...
  UrlPreview.prototype.showErrorMessage = function () {
    this.urlPreview.classList.add('govuk-pub-url-preview__url--hidden')
    this.defaultMessage.classList.add('govuk-pub-url-preview__default-message--hidden')
    this.errorMessage.classList.remove('govuk-pub-url-preview__error-message--hidden')
  }

  UrlPreview.prototype.showNoTitleMessage = function () {
    this.urlPreview.classList.add('govuk-pub-url-preview__url--hidden')
    this.defaultMessage.classList.remove('govuk-pub-url-preview__default-message--hidden')
    this.errorMessage.classList.add('govuk-pub-url-preview__error-message--hidden')
  }

  UrlPreview.prototype.showPathPreview = function (path) {
    this.urlPreview.classList.remove('govuk-pub-url-preview__url--hidden')
    this.defaultMessage.classList.add('govuk-pub-url-preview__default-message--hidden')
    this.errorMessage.classList.add('govuk-pub-url-preview__error-message--hidden')
