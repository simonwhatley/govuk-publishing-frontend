...
(function (Modules) {
  ...
  CookieBanner.prototype.start = function ($module) {
    ...
    this.$module.cookieBanner = document.querySelector('.govuk-pub-cookie-banner')
    this.$module.cookieBannerConfirmationMessage = this.$module.querySelector('.govuk-pub-cookie-banner__confirmation')
  ...
  CookieBanner.prototype.showConfirmationMessage = function () {
    this.$cookieBannerMainContent = document.querySelector('.govuk-pub-cookie-banner__wrapper')
