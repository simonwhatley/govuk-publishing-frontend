...
(function (Modules) {
  ...
  */
  ...
  Expander.prototype.replaceHeadingSpanWithButton = function (expanded) {
    ...
    $button.classList.add('govuk-pub-expander__button')
  ...
  Expander.prototype.toggleContent = function (e) {
    if (this.$toggleButton.getAttribute('aria-expanded') === 'false') {
      ...
      this.$content.classList.add('govuk-pub-expander__content--visible')
    } else {
      this.$toggleButton.setAttribute('aria-expanded', false)
      this.$content.classList.remove('govuk-pub-expander__content--visible')
    }
  }
  ...
  Expander.prototype.attachSelectedCounter = function attachSelectedCounter (selectedString) {
    ...
    $selectedCounter.classList.add('govuk-pub-expander__selected-counter')
